      ...
      <section id="sec-10" className="container">
        <div className="row">
          ...
          <div className="col-xl-10 col-xxl-9 mb-5">
            <h4 className="text-center text-md-start mb-2 mb-sm-4">
              Предоставляемые услуги
            </h4>
            <div className="fs-11 text-center text-md-start">
              Пользователь не предоставляет услуг
            </div>
            <div className="user-card page">
              ...
              <div className="desc mb-3 mb-sm-4">
                <div className="fs-11 fw-5 gray-2 mb-3">
                  Опыт работы от 1 года
                </div>
                <div className="fw-3">
                  <p>
                    Создание индивидуального дизайна по Вашим предпочтениям.
                    Помощь в подброре отделочных материалов, мебели и текстиля.
                    Примеры работ в личных сообщениях.
                  </p>
                </div>
              </div>
          ...
          <div className="col-xl-10 col-xxl-9 mb-5">
            ...
            <div className="fs-11 text-center text-md-start mb-4">
              Нет отзывов
            </div>
            <button
              type="button"
            ...
            <div className="review mb-3">
              <img
                src="/real_estate/img/photo2.png"
                alt="Андрей Шевцов"
              ...
              <div className="ms-sm-4">
                ...
                <div>
                  <p>
                    ...
                    mauris, habitasse iaculis donec nec. Massa egestas
                    vestibulum cursus justo, quis lectus.
                  </p>
                </div>
                <div className="date fs-11 gray-3">21.09.21</div>
                <button type="button" className="claiming color-1 fs-09">
                  Пожаловаться
                </button>
              </div>
            </div>
            ...
            <button type="button" className="fs-12 fw-5 color-1 mx-auto bb-1">
              Показать еще
            </button>
          </div>
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-body">
              ...
              <h4 className="text-center color-1 mb-2 mb-sm-4">
                Оставьте отзыв
              </h4>
              <form>
                <div className="row">
...
=======
                  <div className="col-lg-4 d-flex flex-lg-column align-items-center mb-2 mb-sm-4 mb-lg-0">
                    ...
                    <div className="text-lg-center">
                      <div className="fs-11 fw-5 mb-sm-2">
                        Колесникова Ирина
                      </div>
