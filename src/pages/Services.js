                        ...
                        <div>
                            <NavLink to="/">
                                <svg width="80" height="105" viewBox="0 0 103 136" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path className="stroke" d="M57.0179 87.2974L57.0179 32.1622"
                                          strokeLinejoin="round"/>
                                    <path className="stroke" d="M68.0367 88.7778L68.0367 47.2223"/>
                                    <rect className="stroke" x="70.4868" y="89.6812" width="12" height="4.96664"
                                          strokeLinejoin="round"/>
                ...
                <div className="row">
                    ...
                    <div className="col-xl-8 col-xxl-9">
                        <div className="d-flex justify-content-between mb-3 mb-xl-2">
                            <button type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasServiceFilter"
                            ...
                            <div
                                className="d-flex flex-column-reverse flex-sm-row align-items-end justify-content-between flex-1 ms-4 ms-xl-0">
                        ...
                        <div className="row px-4 px-sm-0 row-cols-sm-2 row-cols-lg-3 row-cols-xl-2 row-cols-xxl-1 g-4">
                                ...
                                <div>
                                    <div className="user-card">
                                        <div className="title">
                                            <div className="d-xxl-flex">
                                                <h4 className="color-1 mb-1 mb-xl-2 mb-xxl-0">
                                                    <NavLink
                                                        to={`/user/${i?.userId}`}
                                                        state={{prevRoute: pathname, routeName: routeName}}
                                                        onClick={() => scrollToTop()}
                                                    >
                                                        {i.user?.fullName}
                                                    </NavLink>
                                        ...
                                        <div className="photo mt-2 mt-md-3 mt-xxl-0">
                                            <NavLink to="/user" onClick={() => scrollToTop()}><img src="/img/photo.png"
                                                                                                   alt="Колесникова Ирина"/></NavLink>
                                        </div>
                                        <div className="desc mt-2 mt-md-3 mt-xxl-0">
                                            <div className="fs-11 gray-2 mb-1 mb-md-2 mb-xxl-3">Опыт работы от 1 года
                                            </div>
                                            <div className="text">
                                                <p>Создание индивидуального дизайна по Вашим предпочтениям. Помощь в
                                                    подброре отделочных материалов, мебели и текстиля. Примеры работ в
                                                    личных сообщениях.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="btns mt-2 mt-md-3 mt-xxl-0">
                                            ...
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#write-message"
                                                    className="d-none d-xxl-block btn btn-1 w-100 px-3">Написать
                                                сообщение
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="user-card">
                                    ...
                                    <div className="photo mt-2 mt-md-3 mt-xxl-0">
                                        <NavLink to="/user" onClick={() => scrollToTop()}><img src="/img/photo.png" alt="Колесникова Ирина"/></NavLink>
                                    </div>
                                    <div className="desc mt-2 mt-md-3 mt-xxl-0">
