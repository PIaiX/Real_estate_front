...
export default function Advertise() {
  ...
  const onSubmit = (e) => {
    ...
    if (requiredElems.length === 0) {
      oldArr.map(
        (item) =>
          (document.querySelector('[data-for="' + item + '"]').style.color =
            "#545454")
      );
            ...
            >
              ...
              {deal === "rent" && (
                <>
                  ...
                  <hr
                    className={
                      deal === "rent" ? "d-none d-md-block my-4" : "d-none"
                    }
                  />
                </>
              )}
                          ...
                          {imageList.map((image, index) => (
                            <div key={index} className="image-item">
                              ...
                              <div className="image-item__btn-wrapper">
                                ...
                                >
                                  <img
                                    src="/real_estate/img/icons/update.svg"
                                    alt="Обновить"
                                  />
                                </button>
                                <button
                                ...
                                >
                                  <img
                                    src="/real_estate/img/icons/delete.svg"
                                    alt="Удалить"
                                  />
                                </button>
                                {index !== mainImg && (
