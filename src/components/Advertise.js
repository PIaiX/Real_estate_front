                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-md-9">
                                    <input
                                        ...
                                        onChange={(e) => {
                                            setData(prevData => {
                                                return {...prevData, "addressOrResidentalComplex": e.target.value}
                                            })
                                        }}
                                    />
                                </div>
                            ...
                            <div className="row row-cols-2 row-cols-md-4 align-items-center mt-4 mt-sm-5">
                                ...
                                <div className="mt-3 mt-sm-4 mt-md-0">
                                    <input
                                        ...
                                        onChange={(e) => {
                                            setData(prevData => {
                                                return {...prevData, "startLivingArea": e.target.value}
                                            })
                                        }}
                                    />
                                </div>
                            ...
                            <div className="row row-cols-2 row-cols-md-4 align-items-center mt-3 mt-sm-4">
                                ...
                                <div>
                                    <input
                                        ...
                                        onChange={(e) => {
                                            setData(prevData => {
                                                return {...prevData, "startKitchenArea": e.target.value}
                                            })
                                        }}
                                    />
                                </div>
