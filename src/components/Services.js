                        ...
                        <div>
                            <NavLink to="/">
                                <svg width="80" height="105" viewBox="0 0 103 136" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path className="stroke" d="M48.4363 26.9384C54.7876 26.9384 59.9363 21.824 59.9363 15.5151C59.9363 9.20617 54.7876 4.0918 48.4363 4.0918C42.0851 4.0918 36.9363 9.20617 36.9363 15.5151C36.9363 21.824 42.0851 26.9384 48.4363 26.9384Z" strokeMiterlimit="10"/>
                                    <path className="stroke" d="M92.3399 117.276H60.1794C58.6398 117.276 57.4423 116.203 57.4423 114.825V97.0593C57.4423 95.681 58.6398 94.6089 60.1794 94.6089H92.3399C93.8795 94.6089 95.0769 95.681 95.0769 97.0593V114.825C95.0769 116.203 93.8795 117.276 92.3399 117.276Z" fill="white" strokeMiterlimit="10"/>
                                    <line className="stroke" x1="95.0769" y1="104.243" x2="57.4423" y2="104.243"/>
                                    <path className="stroke" d="M17.796 41.4682C17.8349 40.5247 18.3132 39.6563 19.1124 39.1533C21.8688 37.4182 28.6882 33.4422 34.7147 32.4731C42.4841 31.2237 51.9183 31.2239 59.1328 32.4731C64.7643 33.4483 73.2278 37.4687 76.6707 39.186C77.6275 39.6633 78.2365 40.6269 78.2807 41.6952L80.0922 85.5718C80.1625 87.2758 78.8001 88.6956 77.0947 88.6956H18.9725C17.2671 88.6956 15.9047 87.2758 15.9751 85.5718L17.796 41.4682Z" fill="white" strokeLinejoin="round"/>
                                    <path className="stroke" d="M28 88L28 48" strokeLinejoin="round"/>
                                    <path className="stroke" d="M40 88L39.5446 32" strokeLinejoin="round"/>
                                    <path className="stroke" d="M57.0179 87.2974L57.0179 32.1622" strokeLinejoin="round"/>
                                    <path className="stroke" d="M68.0367 88.7778L68.0367 47.2223"/>
                                    <rect className="stroke" x="70.4868" y="89.6812" width="12" height="4.96664" strokeLinejoin="round"/>
