                ...
                <div className="row">
                    ...
                    <div className="col-5">
                        <div className="h-100 d-flex flex-column justify-content-between align-items-start">
                            <div>
                                <div className="color-1 title-font fw-7 fs-15 mb-4">{props.title}</div>
                    ...
                    <div className="col-3">
                        ...
                        <div className="w-fit d-flex flex-column align-items-center ms-auto mt-4">
                            <img src="/real_estate/img/img-photo.svg" alt="Фото"/>
                            <div className="gray-2 fw-5 fs-09 mt-2">Колесникова Ирина</div>
                            <div className="gray-3 fs-08 mt-2">На сайте с сентября 2021</div>
                            <button type="button" className="btn btn-1 fs-09 mt-3">Показать телефон</button>
                        </div>
                    </div>
                </div>
