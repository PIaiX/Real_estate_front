                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <div className="row">
                            <div className="col-xxl-7">
                                <div className="h-100 d-flex flex-column justify-content-between align-items-start">
                                    <div>
                                        ...
                                        <div className="address d-flex align-items-center mb-2 mb-xxl-3">
                            ...
                            <div className="col-xxl-5 mt-3 mt-xxl-0">
                                <div className="row">
                                    ...
                                    <div className="col-6 col-xxl-12">
                                        <div className="author w-fit d-flex flex-xxl-column align-items-xxl-center ms-xxl-auto mt-xxl-4">
                                            <img src="/real_estate/img/img-photo.svg" alt="Фото"/>
                                            <div className="ms-2 ms-xxl-0">
                                                <div className="gray-2 fw-5 fs-09 mt-xxl-2">Колесникова Ирина</div>
                                                <div className="gray-3 fs-08 mt-1 mt-xxl-2">На сайте с сентября 2021</div>
                                                <button type="button" className="btn btn-1 fs-09 mt-2 mt-xxl-3 px-3">Показать телефон</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
