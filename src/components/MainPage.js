    ...
    return (
        <main>
            ...
            <section id="sec-2" className="container tiles px-xxl-5 mb-6">
                ...
                />
                <Tile
                    img="/real_estate/img/icons/icon-7.svg"
                    simpleLink={{title: "Дизайн", url: "/service"}}
                />
                <Tile
                    img="/real_estate/img/icons/icon-8.svg"
                    simpleLink={{title: "Ремонт", url: "/service"}}
                />
                <Tile
                    img="/real_estate/img/icons/icon-9.svg"
                    simpleLink={{title: "Грузоперевозки", url: "/service"}}
                />
                <Tile
                    img="/real_estate/img/icons/icon-10.svg"
                    simpleLink={{title: "Услуги риелторов", url: "/service"}}
                />
            </section>
