    ...
    return (
        <main>
            ...
            <section id="sec-2" className="container tiles px-xxl-5 mb-6">
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-1.svg" alt="Сдать"/>
                    <div className="links">
                ...
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-2.svg" alt="Недвижимость"/>
                    <div className="links">
                ...
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-3.svg" alt="Паркинг"/>
                    <div className="links">
                        <a href="/">Гараж</a>
                        <a href="/">Паркинг</a>
                        <div className="hover-links">
                ...
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-4.svg" alt="Земельные участки"/>
                    <div className="links">
                ...
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-5.svg" alt="Коммерческая недвижимость"/>
                    <div className="links">
                ...
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-6.svg" alt="Ипотека"/>
                    <div className="links">
                        <a href="/">Ипотека</a>
                    </div>
                </div>
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-7.svg" alt="Дизайн"/>
                    <div className="links">
                        <a href="/">Дизайн</a>
                    </div>
                </div>
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-8.svg" alt="Ремонт"/>
                    <div className="links">
                        <a href="/">Ремонт</a>
                    </div>
                </div>
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-9.svg" alt="Грузоперевозки"/>
                    <div className="links">
                        <a href="/">Грузоперевозки</a>
                    </div>
                </div>
                <div className="tile">
                    <img src="/real_estate/img/icons/icon-10.svg" alt="Услуги риелторов"/>
                    <div className="links">
